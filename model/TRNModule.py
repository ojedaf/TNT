...
class RelationModule(torch.nn.Module):
    ...
    def __init__(self, img_feature_dim, num_frames, out_dim = 512):
...
class RelationModuleMultiScale(torch.nn.Module):
    ...
    def __init__(self, img_feature_dim, num_frames, out_dim = 256):
...
def return_TRN(relation_type, img_feature_dim, num_frames, out_dim = 256):
    if relation_type == 'TRN':
        TRNmodel = RelationModule(img_feature_dim, num_frames, out_dim)
    elif relation_type == 'TRNmultiscale':
        TRNmodel = RelationModuleMultiScale(img_feature_dim, num_frames, out_dim)
    else:
